...
from lib.order_dataset import active_scope_name, load_project_config, project_path, sort_cluster_ids
...
def run_from_config(config: dict[str, Any] | str | Path | None = None) -> dict[str, Any]:
    ...
    from lib import network_distance  # local import: keeps osmnx/geopandas off the hot import path

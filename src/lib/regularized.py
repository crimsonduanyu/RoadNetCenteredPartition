...
from lib.geo import PROJECT_ROOT, project_path


# Objective/search tolerance. Intentionally distinct from lib.metrics.EPS (1e-9),
# which is a metric safe-divide floor; do not merge the two.
EPS = 1.0e-12
